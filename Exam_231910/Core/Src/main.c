...
/* USER CODE BEGIN PV */
uint16_t duty_LED = 0; //Define variable that to save the value PWM
uint16_t maxDuty = 0; //Define variable by limit cycle
uint16_t value_PWM = 0; //Define value that to save the value PWM by print.
